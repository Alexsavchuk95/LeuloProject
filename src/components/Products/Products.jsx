    ...
    <section className={styles.wrapperPr}>
      <div className={styles.containerPr}>
        <div className={styles.bounceCont}>
          ...
          <img
            id={styles.bottle}
            src="https://static.wixstatic.com/media/5bd4e0_d17d441e93304fda9e96aaa09b53906d~mv2.png/v1/fill/w_185,h_355,al_c,q_85,usm_0.66_1.00_0.01/Bounce%20back%20blend.webp"
            alt=""
          />
        </div>
      ...
      <div className={styles.containerPr}>
        ...
        <div className={styles.bounceCont}>
          ...
          <img
            id={styles.red}
            className={styles.anImg}
            src="https://static.wixstatic.com/media/5bd4e0_b6d52a724c904bd2805c80cc14d1c49c~mv2.png/v1/fill/w_240,h_135,al_c,q_85,usm_0.66_1.00_0.01/B12.webp"
            alt=""
          />
          <img
            id={styles.dewBtl}
            src="https://static.wixstatic.com/media/5bd4e0_7eebd06f23344ea78ac0ab27eea35a39~mv2.png/v1/fill/w_185,h_365,al_c,q_85,usm_0.66_1.00_0.01/dew%20elixir.webp"
            alt=""
          />
        </div>
      </div>
